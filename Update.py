...
class Update:
    ...
    Handles both single-person and dual-person boat moves.
    """
    ...
    def generate_children(self,state):
        """Generate children be moving boat left or right."""
    ...
    def __go_to_right(self,state, children):
        """Generate moves from left to right."""
    ...
    def __go_to_left(self,state, children):
        """Generate moves from right to left."""
    ...
    def __dual_transmission(self, state, children):
        """Generate states where two people cross together."""
        ...
        for index_person1 in range(origin_side_length):
            for index_person2 in range(0 ,origin_side_length):
                ...
                if person1 == person2: # Can't take the same person twice
                    continue
                ...
                #Update origin and deestination sides
    ...
    def __single_transmission(self, state, children):
        """Generate states where one person crosses alone."""
        ...
        for person in origin_side:
            ...
            if Validation.can_drive(person): # Only drivers can move alone
